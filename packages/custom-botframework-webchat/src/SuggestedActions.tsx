...
import { CardAction, Message, Activity } from '@bfemulator/custom-botframework-directlinejs';
...
class SuggestedActionsContainer extends React.Component<SuggestedActionsProps, {}> {
...
export const SuggestedActions = connect(
  (state: ChatState) => ({
      ...
      // only used to create helper functions below
      sendMessage
  }, (stateProps: any, dispatchProps: any, ownProps: any): SuggestedActionsProps => ({
      // from stateProps
