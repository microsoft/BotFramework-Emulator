        ...
        <div { ...CSS }>
          {
            ...
            <>
              ...
              <PrimaryButton text="Hide Visualizer" buttonClass='visualizer-button' onClick={ this.toggleShowing } />
            </>

            :

            <PrimaryButton text="Show visualizer" buttonClass='visualizer-button' onClick={ this.toggleShowing } />
          }
        </div>
      );
    } else return null;
