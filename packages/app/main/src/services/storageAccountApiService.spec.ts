...
const mockResponseTemplate = [
  ...
  },
  {
    value: [
      {
        'id': '/subscriptions/174/resourceGroups/blob/providers/Microsoft.Storage/storageAccounts/storageAccountName/' +
  ...
  it('should deliver BlobStorageServices when the happy path is followed', async () => {
    ...
    expect(result).toEqual({
      'services': [
        {
          'type': 'blob',
          'id': '/subscriptions/174/resourceGroups/blob/providers/Microsoft.Storage/storageAccounts/' +
            'storageAccountName/blobServices/default/containers/containerName',
          'tenantId': '1234',
          'subscriptionId': '1234',
          'name': 'containerName',
          'connectionString': 'DefaultEndpointsProtocol=https;AccountName=AStorage;' +
